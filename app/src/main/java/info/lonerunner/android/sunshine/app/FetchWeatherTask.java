...
public class FetchWeatherTask extends AsyncTask<String, Void, Void>
{
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon)
    {
        ...
        } else
        {
            ...
            Uri mNewUri = mContext.getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
            Log.v("returned Uri", mNewUri.toString());
            ...
            throws JSONException
    {
        ...
        long location_id = addLocation(locationSetting, cityName, cityLatitude, cityLongitude);
...
//        long locationID = addLocation(locationSetting, cityName, cityLatitude, cityLongitude);
        ...
        for (int i = 0; i < weatherArray.length(); i++)
        {
            ...
            ContentValues values = new ContentValues();
            values.put(WeatherContract.WeatherEntry.COLUMN_LOC_KEY, location_id);
